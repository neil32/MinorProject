    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <p>You have done <b>no update</b> on the event!</p>
            <p>click below to update events.</p>
            <div class="ln_solid"></div>
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <a href="updateevent.php"><button type="button" name="btn" class="btn btn-success">Update</button></a>
              </div>
            </div>
          </div>
        </div>
