    ...
    if(!empty($rs))
    {
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>DELETE EVENT <small></small></h2>
            ...
            <div class="x_content">
              <br/>
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="deleteevent2.php" method="post">
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12"> Delete Event By Event ID
                  </label>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="btn1" class="btn btn-success">Delete</button>
                  </div>
                </div>
              </form>
              ...
              <div class="form-group">
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="deleteevent2.php" method="post">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" >Delete Event By Event Name
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="btn2"  class="btn btn-success">Delete</button>
                </div>
                </form>
              </div>
            </div>
