      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br/>
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="assignfc2.php" method="POST">
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <input type="submit" name="btn" value="Submit" id="btn" class="btn btn-success"/>
                  </div>
                </div>
              </form>
            </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br/>
              <p>SORRY NO EVENTS TO ASSIGN FACULTY CO-ORDINATORS!</p>
            </div>
          </div>
        </div>
      </div>
