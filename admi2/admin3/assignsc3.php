  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Student Co-ordinators Assigned Successfully!</h2>
          ...
          <div class="x_content">
            <br/>
            <p>The Student Co-ordinators have been assigned succesfully!</p>
            <p>click below to assign more co-ordinatos.</p>
            <div class="ln_solid"></div>
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <a href="assignsc1.php"><button type="button" name="btn" class="btn btn-success">Assign More</button></a>
