...
{
  header("location:searchparticipantsc.php");
}
?>
<!-- page header -->
      ...
      <div class="x_panel">
        ...
        <div class="x_content">
                ...
                if($row2=$result2->fetch_assoc())
                {
                  ...
                  <tr>
                    ...
                    if(empty($row2["total"]))
                    {
                      ...
                      ?>
                      <td><a href="viewparticipantsc.php?id=<?php echo $eid; ?>">view</a></td>
                      <?php
                    }
                    ?>
                  </tr>
                ...
                if($row=$result->fetch_assoc())
                {
                  ...
                  if($row2=$result2->fetch_assoc())
                  {
                    ...
                    <tr>
                      ...
                      <td><?php echo $row["eventname"]; ?></td>
                      <td><?php echo $row2["total"]; ?></td>
                      <td><a href="viewparticipantsc.php?id=<?php echo $row["eventid"]; ?>">view</a></td>
                    </tr>
                    <?php
                  }
                }
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            <br/>
            <a href="searchparticipantsc.php"><button type="button" name="btn" class="btn btn-success">Search More</button></a>
          </div>
        </div>
      </div>
    </div>
