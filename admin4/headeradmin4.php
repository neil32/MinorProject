            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                ...
                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                  <li><a href="profile4.php">  Profile</a>
                  </li>
                  <li><a href="setting4.php">  Setting</a>
                  </li>
                  <li>
                    <a href="help4.php"> Help</a>
                  </li>
                  <li><a href="logout4.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </li>
                </ul>
              </li>
            </ul>
