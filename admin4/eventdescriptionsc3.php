  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Event Description Added Successfully!</h2>
          ...
          <div class="x_content">
            <br/>
            <p>The event description has been added successfully!</p>
            <p>click below to add more event description.</p>
            <div class="ln_solid"></div>
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <a href="eventdescriptionsc.php"><button type="button" name="btn" class="btn btn-success">Assign More</button></a>
