...
include("conn.php");
$year=$_SESSION['eyear'];
$qr="SELECT max(eventid) FROM eventdetails WHERE eventyear=?";
$preparedstmt = $conn->prepare($qr);
$preparedstmt->bind_param("s", $year);
$preparedstmt->execute();
$preparedstmt->bind_result($id);
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br/>
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="addevent2.php" method="POST">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Event ID </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" id="eid" class="form-control col-md-7 col-xs-12" name="eid" value="<?php echo $maxid;  ?>" >
                  <div class="exists"></div>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Event Name<span style="color:red;" class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="ename" class="form-control col-md-7 col-xs-12" name="ename" required="required">
                </div>
              </div>
