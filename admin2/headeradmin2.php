...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../files/css/maps/jquery-jvectormap-2.0.3.css" />
  ...
  <script src="../files/js/jquery.min.js"></script>  <script src="../files/js/nprogress.js"></script>
  <!--[if lt IE 9]>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="">
              <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <img src="../files/images/profile/techie1.jpg" alt=""><?php echo $adminname; ?>
                <span class=" fa fa-angle-down"></span>
              </a>
              <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                <li><a href="profile2.php">  Profile</a>
                </li>
                <li><a href="setting2.php">  Setting</a>
                </li>
                <li>
                  <a href="help2.php"> Help</a>
                </li>
                <li><a href="logout2.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                </li>
              </ul>
            </li>
          </ul>
