      ...
      <div class="x_panel">
        ...
        <div class="x_content">
                  ...
                  if($preparedstmt2->fetch())
                  {
                    ...
                    <tr>
                      ...
                      if(empty($row3))
                      {
                        ...
                        ?>
                        <td><a href="viewparticipantdh.php?id=<?php echo $row1; ?>">view</a></td>
                        <?php
                      }
                      ?>
                    </tr>
            ...
            elseif(isset($_POST['btn2']))
            {
              ...
              if(!empty($rs2))
              {
                if($preparedstmt->fetch())
                {
                  ...
                  $preparedstmt2->bind_param("i", $row4);
                  $preparedstmt2->execute();
                  $preparedstmt2->bind_result($row6);
                  if($preparedstmt2->fetch())
                  {
                    ?>
                    <tr>
                      ...
                      if(empty($row6))
                      {
                        ...
                        ?>
                        <td><a href="viewparticipantdh.php?id=<?php echo $row4; ?>">view</a></td>
                      <?php } ?>
                    </tr>
                    <?php
                  }
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            <br/>
            <a href="searchparticipantdh.php"><button type="button" name="btn" class="btn btn-success">Search More</button></a>
          </div>
        </div>
      </div>
    </div>
